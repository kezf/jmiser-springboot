...
var refreshItem = function(){
	...
	var target = $('.app_iframe[data-id="' + currentId + '"]', topWindow);
...
function createMenuItem(dataUrl, menuName) {
    ...
    if (flag) {
        ...
        // 添加选项卡对应的iframe
        var str1 = '<iframe class="app_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" data-panel="' + panelUrl + '" seamless></iframe>';
