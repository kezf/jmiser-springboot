...
public class SysRoleController extends BaseController {
    ...
    @Log(title = "角色管理", action = Action.EXPORT)
    ...
    @Log(title = "角色管理", action = Action.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "角色管理", action = Action.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "角色管理", action = Action.DELETE)
    @PostMapping("/remove")
    @ResponseBody
     ...
     * 取消授权
     */
    @Log(title = "角色管理", action = Action.GRANT)
