...
import org.miser.framework.shiro.service.SysPasswordService;
...
public class SysUserController extends BaseController {
    ...
    @Log(title = "用户管理", action = Action.EXPORT)
    ...
    @Log(title = "用户管理", action = Action.IMPORT)
    ...
    @Log(title = "用户管理", action = Action.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "用户管理", action = Action.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "重置密码", action = Action.UPDATE)
    ...
    @Log(title = "用户管理", action = Action.DELETE)
    @PostMapping("/remove")
    @ResponseBody
